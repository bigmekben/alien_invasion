...
class AlienInvasion:
    ...
    def _check_keydown_events(self, event):
        ...
        self._check_keys_always_apply(event)
            
        if self.stats.game_active:
            self._check_game_only_keys(event)
            
    def _check_keys_always_apply(self, event):
    ...
    def _check_game_only_keys(self, event):
    ...
    def _update_bullets(self):
        ...
        # Git rid of bullets that have gone offscreen.
